...
import { Linkedin, Twitter, ShieldCheck, FileText, Cookie, AlertCircle, Info, Mail, Github } from "lucide-react";
  ...
  return (
    <footer className="w-full border-t border-primary/5 bg-card/20 backdrop-blur-xl mt-auto transition-all duration-500">
      <div className="max-w-7xl mx-auto px-6 py-6 lg:py-8">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <Link key={item.label} href={item.href} className="group flex items-center gap-3 px-4 py-2.5 rounded-2xl glass hover:bg-primary/5 hover:border-primary/20 transition-all text-[11px] font-black uppercase tracking-widest text-foreground/70 active:scale-95">
        ...
        <div className="mt-8 pt-6 border-t border-primary/5 text-center space-y-2">
