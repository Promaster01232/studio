...
const disclaimerNodes = [
  {
    ...
    desc: "Our dashboard utilizes probabilistic LLM nodes. While optimized for forensic accuracy, outputs—including case summaries and document drafts—are generated via neural processing and may contain hallucinated sections or outdated legal citations.",
    icon: BrainCircuit,
  ...
  },
  {
    ...
    desc: "Utilization of Nyaya Sahayak tools does NOT create an attorney-client relationship. The information provided is for navigational and educational purposes only. Direct advice is only available through our Verified Advocate Registry.",
    icon: Users,
    color: "text-blue-500",
    bg: "bg-blue-500/10",
  ...
  },
  {
    ...
    desc: "The platform's intelligence nodes are primarily trained on the Indian Judicial System. Use of these tools for legal matters in foreign jurisdictions is not recommended and is done at the user's sole risk.",
    icon: Landmark,
  ...
  },
  {
    ...
    desc: "IdeaSpark and its nodes are not liable for any legal outcomes, financial losses, or procedural failures resulting from reliance on AI-generated data. Users are responsible for all official filings and legal strategies.",
    icon: ShieldAlert,
    ...
    <div className="max-w-5xl mx-auto space-y-8 sm:space-y-12 pb-20 px-2 sm:px-0">
          ...
          <Card className="border-none ring-1 ring-destructive/20 bg-destructive/5 rounded-3xl overflow-hidden shadow-xl h-full">
            <CardContent className="p-6 sm:p-8 space-y-4 text-left">
              ...
              <p className="text-xs sm:text-sm font-bold leading-relaxed text-destructive/80">
                The AI Nyaya Mitra Assistant is <span className="underline decoration-2 underline-offset-4">NOT</span> a law firm or a government entity. We do not provide official legal advice, only AI-driven forensic intelligence and procedural roadmaps.
              </p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="border-none ring-1 ring-amber-500/20 bg-amber-500/5 rounded-3xl overflow-hidden shadow-xl h-full">
            <CardContent className="p-6 sm:p-8 space-y-4 text-left">
              ...
              <p className="text-xs sm:text-sm font-bold leading-relaxed text-amber-600/80">
                All documents generated by AI nodes <span className="underline decoration-2 underline-offset-4">MUST</span> be reviewed, edited, and finalized by a qualified human advocate before service or filing in any official court of law.
              </p>
            </CardContent>
          </Card>
        </motion.div>
      ...
      <motion.div variants={itemVariants} initial="hidden" animate="visible" className="text-center space-y-4">
        ...
        <p className="text-[9px] sm:text-[10px] text-muted-foreground/60 font-medium max-w-2xl mx-auto leading-relaxed italic px-4">
          "By accessing Nyaya Sahayak, you explicitly waive any claims against the developers regarding the performance of AI nodes. Accuracy verification rests entirely with the user and their authorized legal counsel."
        </p>
      </motion.div>
    </div>
  );
