...
const termSections = [
  {
    ...
    icon: ShieldCheck,
    content: "By accessing the Nyaya Sahayak node at nyayasahayak.in, you agree to be bound by these Terms. Failure to accept every clause requires immediate session termination and node disconnection."
  },
  {
    title: "2. The AI Intelligence Mandate",
    icon: Bot,
    content: "Nyaya Sahayak utilizes probabilistic AI nodes. AI outputs are generated via neural processing and do not constitute 'Legal Advice' as defined by statutory regulations. Outputs are navigational."
  },
  {
    title: "3. Human Review Requirement",
    icon: Gavel,
    content: "CRITICAL: Any legal document generated via nyayasahayak.in must be reviewed and finalized by a human advocate before filing. Reliance on raw AI output for official filing is prohibited."
  },
  {
    title: "4. Registry Identity & Security",
    icon: Fingerprint,
    content: "Users must provide authentic data during enrollment. Submission of fraudulent Bar IDs or deceptive narrations will trigger immediate Node Deactivation. You are responsible for your authentication registry."
  },
  {
    title: "5. Lawyer Connect Ecosystem",
    icon: Globe,
    content: "The Advocate Registry is a directory of independent legal professionals. Nyaya Sahayak facilitates connection nodes but does not employ or endorse specific advocates."
  },
  {
    title: "6. Forensic Data Usage",
    icon: Lock,
    content: "Your data is processed according to our Privacy Protocol with AES-256 encryption. You maintain sovereign authority over your data nodes, including the right to trigger a 'Registry Purge'."
  },
  {
    title: "7. Prohibited Node Activities",
    icon: Ban,
    content: "Users are prohibited from attempting to reverse-engineer AI logic, submitting malicious code, or automating data extraction via unauthorized bots on nyayasahayak.in."
  },
  {
    title: "8. Limitation of Liability",
    icon: Scale,
    content: "IdeaSpark and Nyaya Sahayak nodes are not liable for direct or indirect damages resulting from platform use, including legal outcomes or errors in judicial navigation."
  }
];
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-20 px-2 sm:px-6 text-left">
      ...
      >
        ...
        />
        <Badge variant="outline" className="font-black text-[9px] uppercase tracking-widest bg-primary/5 text-primary border-primary/10 px-4 py-1.5 rounded-full">Protocol Agreement</Badge>
      </motion.div>
      ...
      >
        <Card className="border-primary/10 shadow-3xl rounded-[3rem] overflow-hidden bg-card/40 backdrop-blur-md border-none ring-1 ring-primary/10 relative">
          ...
          <CardHeader className="bg-primary/5 border-b border-primary/5 p-8 sm:p-12 relative overflow-hidden">
            <div className="flex flex-col sm:flex-row items-center gap-6 relative z-10 text-center sm:text-left">
              ...
              <div className="space-y-1">
                <CardTitle className="text-3xl sm:text-5xl font-black tracking-tighter uppercase leading-tight">Access Agreement</CardTitle>
          ...
          <CardContent className="p-8 sm:p-16 space-y-16">
            ...
            >
              ...
              <p className="text-sm sm:text-lg font-black text-destructive/80 leading-relaxed uppercase tracking-tight">
                NOTICE: Nyaya Sahayak is an AI legal intelligence platform. It does NOT provide official legal advice. Every document generated MUST be reviewed by an advocate.
              </p>
            </motion.div>
        ...
        <motion.div variants={itemVariants} className="text-center space-y-4 pt-4 px-4">
          ...
          <p className="text-[10px] sm:text-xs text-muted-foreground/60 font-bold max-w-3xl mx-auto leading-relaxed italic uppercase tracking-tighter">
            "By utilizing the nyayasahayak.in dashboard, you confirm your understanding that judicial proceedings are complex and AI serve as a navigational node, not a final procedural authority."
          </p>
        </motion.div>
      </motion.div>
    </div>
