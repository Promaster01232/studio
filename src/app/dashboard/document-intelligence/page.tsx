                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 mt-2">
                                    <Badge variant="outline" className="bg-green-500/10 text-green-500 border-green-500/20 text-[8px] font-black px-2">verified scan</Badge>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pt-20">
                <Card className="max-w-md mx-auto bg-destructive/5 border-destructive/20 p-8 rounded-[2rem] space-y-6">
                    ...
                    <div className="space-y-2 text-center">
                        <h3 className="text-xl font-black tracking-tight text-destructive uppercase">ingress refused</h3>
                        <p className="text-sm font-medium text-gray-500 leading-relaxed">{state.error}</p>
                    </div>
                    <Button onClick={handleReset} className="w-full h-12 bg-destructive text-white font-black tracking-widest text-[10px] rounded-xl active:scale-95 transition-all">
                        reset registry
                    </Button>
                </Card>
            </motion.div>
