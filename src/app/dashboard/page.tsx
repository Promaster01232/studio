            ...
            <div className="px-4 pb-4 space-y-4 relative z-10">
                ...
                <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1">
                        ...
                        <Button variant="ghost" className="h-10 px-4 rounded-full gap-2 hover:bg-primary/5 text-muted-foreground font-black text-[10px]">
                ...
                <CardContent className="p-10 sm:p-16 flex flex-col md:flex-row items-center gap-12 relative z-10 text-center md:text-left">
                    <div className="space-y-6 flex-1">
                        <div className="space-y-3">
                            ...
                            <h3 className="text-3xl sm:text-5xl font-black font-headline tracking-tighter leading-[0.9]">elevate your <br /> <span className="opacity-80">authority.</span></h3>
