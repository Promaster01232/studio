    ...
    <div className="max-w-6xl mx-auto space-y-16 pb-32 px-4 sm:px-6">
        ...
        <Card className="bg-[#161b22] border-white/5 rounded-3xl overflow-hidden shadow-2xl">
          <CardContent className="p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 text-left">
            <div className="flex items-center gap-5">
              ...
              <div className="space-y-1">
                <div className="flex flex-wrap items-center gap-3">
                  <h2 className="text-xl sm:text-3xl font-black tracking-tighter text-white leading-none lowercase">
                    {greeting}, {userProfile?.firstName?.toLowerCase() || "friend"}!
                  </h2>
                  <Badge variant="secondary" className="bg-white/5 text-gray-400 border-white/10 font-bold text-[9px] lowercase tracking-widest px-2.5 py-0.5 rounded-lg">
                    free tier
                  </Badge>
                </div>
                <p className="text-xs sm:text-sm text-gray-500 font-medium tracking-tight lowercase">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <Button variant="outline" className="flex-1 md:flex-none h-11 px-6 rounded-xl border-white/10 bg-white/5 text-white font-bold text-xs gap-2 lowercase" asChild>
                <Link href="/dashboard/document-intelligence"><Upload className="h-4 w-4" /> upload</Link>
              </Button>
              <Button className="flex-1 md:flex-none h-11 px-6 rounded-xl bg-primary text-primary-foreground font-black text-xs lowercase tracking-widest shadow-lg shadow-primary/20 gap-2" asChild>
      ...
      <div className="flex flex-col items-center justify-center pt-10 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="space-y-4 mb-10">
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white leading-tight lowercase">hello, how can i help you?</h1>
          <p className="text-gray-400 text-lg font-medium max-w-2xl mx-auto leading-relaxed lowercase">ask nyayguru about indian statutes, procedural roadmaps, or case research.</p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="w-full max-w-3xl">
          <Card className="bg-[#161b22] border border-white/5 rounded-3xl overflow-hidden shadow-2xl">
            <div className="p-6 space-y-4 text-left">
              <Textarea placeholder="ask nyayguru legal ai..." className="bg-transparent border-none focus-visible:ring-0 text-white text-lg placeholder:text-gray-600 min-h-[120px] resize-none p-0 custom-scrollbar lowercase" />
              <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between pt-4 border-t border-white/5">
                <div className="flex items-center gap-4 text-gray-500">
                  ...
                  <div className="flex items-center gap-1.5 hover:text-gray-300 transition-colors cursor-pointer">
                    <Clock className="h-3.5 w-3.5" /> <span className="text-[10px] font-black lowercase tracking-widest">saved</span>
                  </div>
                </div>
      ...
      <section className="pt-20 space-y-16">
        <div className="text-center space-y-4">
          <Badge variant="outline" className="bg-amber-500/5 text-amber-500 border-amber-500/20 px-4 py-1 rounded-full text-[9px] font-black tracking-widest lowercase">ai tool registry</Badge>
          <h2 className="text-3xl sm:text-5xl font-black tracking-tighter text-white lowercase">what you can do with nyayguru</h2>
          <p className="text-gray-500 text-sm sm:text-base max-w-2xl mx-auto font-medium lowercase">explore our suite of ten elite legal research terminals, synced with your account.</p>
        </div>
              ...
              <Link href={f.href}>
                <Card className="bg-[#161b22] border-white/5 rounded-[2rem] h-full overflow-hidden hover:border-primary/30 transition-all duration-500 group cursor-pointer active:scale-95">
                  <CardContent className="p-6 flex flex-col gap-4 text-left">
                    ...
                    <div className="space-y-1">
                      <h3 className="font-black text-sm text-white tracking-tight leading-none lowercase">{f.title}</h3>
                      <p className="text-[10px] text-gray-500 leading-relaxed font-medium line-clamp-3 lowercase">{f.desc}</p>
                    </div>
                  </CardContent>
                </Card>
              </Link>
      ...
      <section className="pt-24 space-y-16">
        <div className="text-center space-y-4">
          <Badge variant="outline" className="bg-amber-500/5 text-amber-500 border-amber-500/20 px-4 py-1 rounded-full text-[9px] font-black tracking-widest lowercase">how it works</Badge>
          <h2 className="text-3xl sm:text-5xl font-black tracking-tighter text-white lowercase">how it works</h2>
          <p className="text-gray-500 text-sm sm:text-base max-w-2xl mx-auto font-medium lowercase">no appointments. no waiting. works 24/7, even at 2 am on a sunday.</p>
        </div>
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="space-y-2 max-w-[240px]">
                <h3 className="font-black text-xl text-white tracking-tight lowercase">{s.title}</h3>
                <p className="text-xs text-gray-500 font-medium leading-relaxed lowercase">{s.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
