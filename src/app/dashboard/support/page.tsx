    ...
    return (
        <div className="space-y-10 max-w-5xl mx-auto pb-20 px-2 sm:px-0 text-left">
            <PageHeader
                ...
                description="Institutional tools to make legal information and platform operations more accessible."
            />
                ...
                <div className="lg:col-span-7 space-y-8">
                                ...
                                <div className="grid sm:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select name="language" value={aiLanguage} onValueChange={setAiLanguage} required>
                                            <SelectTrigger id="language" className="h-12 glass font-bold rounded-xl">
                                                <SelectValue />
                                            </SelectTrigger>
                    ...
                    <Card className="glass shadow-2xl rounded-[2.5rem] overflow-hidden border-primary/5">
                        <CardHeader className="p-8 sm:p-10 border-b border-primary/5 bg-muted/10 text-left">
                            ...
                            <CardDescription className="text-xs font-medium">Select your preferred interface language node.</CardDescription>
                        </CardHeader>
                ...
                <div className="lg:col-span-5 space-y-8">
                    <Card className="border-amber-500/20 bg-amber-500/5 shadow-2xl rounded-[2.5rem] overflow-hidden sticky top-24">
                        <CardHeader className="p-8 border-b border-amber-500/10 bg-amber-500/10 text-left">
                            ...
                            <CardDescription className="text-xs font-medium text-amber-700/70">Assistance for statutory clearance & payment nodes.</CardDescription>
                        </CardHeader>
                        <CardContent className="p-8 space-y-8 text-left">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-[11px] font-medium text-muted-foreground leading-relaxed italic">
                                    "For failed node synchronizations, please include your transaction reference ID from Razorpay in the subject line."
                                </p>
                            </div>
