      ...
      <Card className="w-full max-w-md shadow-lg bg-card/60 backdrop-blur-sm border-primary/20 overflow-hidden">
        <CardContent className="flex flex-col items-center p-8 text-center">
          <div className="relative mb-6">
            ...
            <Image src="https://storage.googleapis.com/project-os-screenshot/1770932454559/image.png" alt="Nyaya Sahayak Logo" width={596} height={524} className="h-36 w-auto relative drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]" />
          </div>
