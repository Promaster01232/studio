...
const cookieNodes = [
  {
    ...
    desc: "Critical for the secure operation of the nyayasahayak.in dashboard. These nodes manage your authentication state and ensure that your registry session remains active during navigation.",
    icon: Lock,
    color: "text-blue-500",
    bg: "bg-blue-500/10",
