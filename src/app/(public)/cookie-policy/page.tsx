...
const cookieNodes = [
  {
    ...
    desc: "Critical for secure operation of the nyayasahayak.in dashboard. These manage your authentication state and ensure that your registry session remains active during navigation.",
    icon: Lock,
    color: "text-blue-500",
    bg: "bg-blue-500/10",
  ...
  },
  {
    ...
    desc: "Used for internal system auditing on nyayasahayak.in. These monitor AI response times and detect dashboard latency without identifying individuals.",
    icon: Activity,
  ...
  },
  {
    ...
    desc: "Enhances your experience by remembering your choice of language (e.g., Hindi, English) and your dark mode/light mode theme configuration across browser restarts.",
    icon: Settings,
  ...
  },
  {
    ...
    desc: "Implemented to prevent unauthorized Cross-Site Request Forgery (CSRF). These verify that actions are initiated strictly by the registered citizen node.",
    icon: ShieldCheck,
          ...
          <CardContent className="p-8 sm:p-16 relative z-10 text-left">
            ...
            <div className="space-y-6 max-w-4xl">
              ...
              <p className="text-sm sm:text-xl text-muted-foreground font-medium leading-relaxed">
                Nyaya Sahayak utilizes minimalist cookie technology strictly to facilitate secure registry sessions and remember your localized preferences. We do <span className="text-foreground font-bold">NOT</span> utilize third-party advertising trackers or sell your behavioral data.
              </p>
            </div>
          </CardContent>
          ...
          <CardContent className="p-8 sm:p-12 space-y-8 text-left">
            ...
            <div className="bg-destructive/5 border border-destructive/20 rounded-[1.5rem] p-6 flex gap-5 items-start shadow-inner">
              ...
              <p className="text-[11px] sm:text-xs font-black text-destructive/80 leading-relaxed uppercase tracking-tighter">
                WARNING: Deactivating "Essential Registry Protocols" will terminate your secure session and may result in the deactivation of generator tools.
              </p>
            </div>
          </CardContent>
        </Card>
